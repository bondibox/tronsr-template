...
When the Super Representative Program ends in 2012, we will use all of the expertise we've gained to continue to run the Tron network. When the program ends, we will spend the entire 4 million TRX that we've accrued in the Payout Account to buy hardware infrastructure on an enterprise level. If you'll excuse our optimism, we believe that will be worth considerably more than the $250,000 as of the date of this writing.
